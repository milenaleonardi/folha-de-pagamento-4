        ...
        switch(opcao) {
            ...
            case 2:
                ...
                if (folha != null) {
                    ...
                    double salarioBruto = FolhaNegocio.calcularSalarioBruto(folha);
                    System.out.println("Salário Bruto: " + salarioBruto);
                    double ir = FolhaNegocio.calcularIR(folha, salarioBruto);
                    System.out.println("IR: " + ir);
                    double inss = FolhaNegocio.calcularINSS(folha, salarioBruto);
...
1               break;
            case 3:
                ...
                folha.setMes(Console.readInt("Mês: "));
                folha.setAno(Console.readInt("Ano: "));
                if(folha.getMes() == folha.getMes() && folha.getAno() == folha.getAno()) {
                    FolhaPersistencia.listarFolha(folha);
                } else System.out.println("Mes e ano não identificados. ");
                break;
        } while (opcao != 4);
